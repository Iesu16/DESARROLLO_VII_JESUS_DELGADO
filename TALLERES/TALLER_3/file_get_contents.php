...
echo "Contenido del archivo ejemplo.txt: <br><br>$contenidoArchivo<br><br>";
...
echo "Contenido del archivo $nombreArchivo: $contenidoPhp";

// Bonus: Usa file_get_contents() para obtener el contenido de una página web
$url = "https://www.example.com";
$contenidoWeb = file_get_contents($url);
echo "Contenido de $url:" . substr($contenidoWeb, 0, 500) . "..."; // Mostramos solo los primeros 500 caracteres

...
echo "<br><br>Información completa de la persona:";
...
$misComidas = ["Pizza", "Hamburguesa", "Emparedado"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Sushi", "Pasta", "Pescado"]; // Reemplaza con las comidas favoritas de tu amigo
$todasLasComidas = array_merge($misComidas, $comidasAmigo);
echo "<br><br>Todas las comidas favoritas:";
...
echo "<br><br>Resultado de merge con claves duplicadas:";
...
echo "<br><br>Todos los números combinados:";
...
echo "<br><br>Colores únicos después de combinar:";

...
echo "<br>Buscando '$buscarNumero' en el array de números:";
echo "<br>Comparación normal: " . (in_array($buscarNumero, $numeros) ? "Encontrado" : "No encontrado") . "";
echo "<br>Comparación estricta: " . (in_array($buscarNumero, $numeros, true) ? "Encontrado" : "No encontrado") . "";
...
echo "<br>Resultados de búsqueda de días:";
...
echo "<br>Buscando persona en el array:";
...
echo "<br>Buscando '$buscarLenguaje' en lenguajes de programación:";

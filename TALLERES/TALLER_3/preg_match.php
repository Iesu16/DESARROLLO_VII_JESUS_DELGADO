...
echo "<br>Usuario de Twitter extraído: " . ($usuario ? "@$usuario" : "No se encontró usuario") . "";
...
echo "<br>¿'{$telefono1}' es un teléfono válido? " . (validarTelefono($telefono1) ? "Sí" : "No") . "
";
echo "<br>¿'{$telefono2}' es un teléfono válido? " . (validarTelefono($telefono2) ? "Sí" : "No") . "
";
...
echo "<br>Etiquetas HTML encontradas: " . implode(", ", $etiquetas) . "";
?>

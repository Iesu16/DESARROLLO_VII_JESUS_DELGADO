...
echo "<br>Números pares: " . implode(", ", $pares) . "";
...
echo "<br>Números primos: " . implode(", ", $primos) . "";

// Ejercicio: Filtra un array de strings para obtener solo las palabras que comienzan con una vocal
$palabras = ["auto", "casa", "elefante", "iglú", "oso", "uva", "zapato", "loto", "flor", "Uruguai"];
$empiezaConVocal = array_filter($palabras, function($palabra) {
    return in_array(strtolower($palabra[0]), ['a', 'e', 'i', 'o', 'u']);
});

echo "<br>Palabras originales: " . implode(", ", $palabras) . "";
echo "<br>Palabras que empiezan con vocal: " . implode(", ", $empiezaConVocal) . "";
...
echo "<br>Personas mayores de 25 años:";
...
echo "<br>Frutas con más de 3 unidades y nombre largo:";

...
define('CLIENT_ID', 'CLIENT_ID'); // Reemplaza con tu client_id de Google OAuth
define('CLIENT_SECRET', 'CLIENT_SECRET'); // Reemplaza con tu client_secret de Google OAuth
